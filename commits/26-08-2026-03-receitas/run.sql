-- =========================================================================
-- run.sql — TODO o SQL rodado na implementação 05 (Receitas).
-- Data: 26/08/2026
--
...
--
-- DEPENDE da implementação 04 (Gastos): o enum `public.currency` é criado lá e
-- REAPROVEITADO aqui — gasto e receita falam da mesma moeda.
--
-- ATENÇÃO ao que esta migration NÃO faz: `category_linked_records` continua
-- contando só gastos. A migration de Gastos previa que `income` entraria nessa
-- conta; a decisão desta foi a oposta — receita NÃO tem categoria (a seção 7
-- explica por quê). Nada muda no módulo de Categorias.
-- =========================================================================


-- >>> supabase/migrations/20260826170132_receitas.sql

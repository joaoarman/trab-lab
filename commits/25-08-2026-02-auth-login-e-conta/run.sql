-- =========================================================================
-- run.sql — 25-08-2026-02-auth-login-e-conta
--
-- TODO o SQL desta implementação, na ordem. É uma migration só.
-- Copiar e colar no SQL Editor do Supabase e executar.
--
-- NÃO cobre a configuração de projeto: enable_confirmations, regra de senha,
-- site_url e rate limits vivem em supabase/config.toml e são aplicados à
-- parte, com `supabase config push`. Os dois planos são independentes.
-- =========================================================================
